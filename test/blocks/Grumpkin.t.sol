...
interface IBn256 {
    ...
    function is_identity(Bn256AffinePoint memory point) external pure returns (bool);
    function decompress(uint256 compressed) external view returns (Bn256AffinePoint memory);
}

interface IGrumpkin {
    function Identity() external pure returns (GrumpkinAffinePoint memory);
    function add(GrumpkinAffinePoint memory p1, GrumpkinAffinePoint memory p2) external view returns (GrumpkinAffinePoint memory);
    function is_identity(GrumpkinAffinePoint memory point) external pure returns (bool);
    function to_affine(uint256 x_input, uint256 y_input, uint256 z_input) external view returns (uint256, uint256);
    function mul_by_3b(uint256 t) external pure returns (uint256);
    function negate(GrumpkinAffinePoint memory point) external pure returns (GrumpkinAffinePoint memory);
    function negateBase(uint256 scalar) external pure returns (uint256);
    function negateScalar(uint256 scalar) external pure returns (uint256);
    function double(GrumpkinAffinePoint memory point) external view returns (GrumpkinAffinePoint memory);
    function scalarMul(GrumpkinAffinePoint memory point, uint256 scalar) external view returns (GrumpkinAffinePoint memory);
    function multiScalarMul(GrumpkinAffinePoint[] memory bases, uint256[] memory scalars) external view returns (GrumpkinAffinePoint memory r);
    function decompress(uint256 compressed) external view returns (GrumpkinAffinePoint memory);
    function getAt(uint256 segment, uint256 c, uint256 scalar) external returns (uint256);
    function multiScalarMulSerial(GrumpkinAffinePoint[] memory bases, uint256[] memory scalars) external returns (GrumpkinAffinePoint memory r);
}
...
contract GrumpkinCurvesContractTests is Test {
    ...
    function setUp() public {
        ...
        string memory bn256_wrappers = vm.readFile("test/blocks/mocks/grumpkin/Bn256Wrappers.huff");
        bn256 = IBn256(HuffDeployer.deploy_with_code("blocks/grumpkin/Bn256", bn256_wrappers));
    }

    function testBnAddition() public {
        Bn256AffinePoint memory a = Bn256AffinePoint(
        ...
        Bn256AffinePoint memory b = Bn256AffinePoint(
        ...
        Bn256AffinePoint memory a_add_b = bn256.add(a, b);
    ...
    function testBnScalarMultiplication() public {
        ...
        Bn256AffinePoint memory a_mul_scalar = bn256.scalarMul(a, scalar);
    ...
    function testBnPointNegation() public {
        ...
        Bn256AffinePoint memory minus_a = bn256.negate(a);
    ...
    function testBnDecompression1() public {
        ...
        Bn256AffinePoint memory point = bn256.decompress(compressedBnPoint);
    ...
    function testGrumpkinPointsAddition() public {
        GrumpkinAffinePoint memory a = GrumpkinAffinePoint(
        ...
        GrumpkinAffinePoint memory b = GrumpkinAffinePoint(
        ...
        GrumpkinAffinePoint memory a_add_b = grumpkin.add(a, b);
    ...
    function testGrumpkinPointsAddition11() public {
        GrumpkinAffinePoint memory a = grumpkin.Identity();
        GrumpkinAffinePoint memory b = grumpkin.Identity();
    ...
    function testGrumpkinScalarMultiplication() public {
        ...
        GrumpkinAffinePoint memory point = GrumpkinAffinePoint(
        ...
        GrumpkinAffinePoint memory result = grumpkin.scalarMul(point, scalar);
