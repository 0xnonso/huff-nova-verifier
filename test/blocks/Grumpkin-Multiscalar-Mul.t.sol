...
import {IGrumpkin} from "./Grumpkin.t.sol";
import {GrumpkinAffinePoint}  from "./Structs.sol";

contract MultiscalarMulTest is Test {
    IGrumpkin grumpkin;
    function setUp() public {
        string memory grumpkin_wrappers = vm.readFile("test/blocks/mocks/grumpkin/GrumpkinMultiScalarMulWrappers.huff");
    ...
    //     GrumpkinAffinePoint[] memory bases = new GrumpkinAffinePoint[](8);
    //     bases[0] = GrumpkinAffinePoint(
    ...
    //     GrumpkinAffinePoint memory out = grumpkin.multiScalarMulSerial(bases, scalars);
    ...
    function testGrumpkin3Unoptimized() public {
        ...
        GrumpkinAffinePoint memory out = grumpkin.multiScalarMul(bases, scalars);
    ...
    //     GrumpkinAffinePoint[] memory bases = new GrumpkinAffinePoint[](16);
    //     bases[0] = GrumpkinAffinePoint(
    //         0x15afa1c1de43e186ee615ee76389d1ca9de572d426869ab062a03f1ba65808a2,
    //         0x28d6d43cb5ba89778111ceaa56cb8bf2c34a5fb6013988513d5798a60846d423
    //     );
