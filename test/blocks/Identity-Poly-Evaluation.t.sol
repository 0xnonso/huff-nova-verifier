...
interface IdentityPolynomialLib {
    function evaluate(uint256[] memory r, uint256 modulus) external returns (uint256);
}

contract IdentityPolyEvaluationTest is Test {
    IdentityPolynomialLib identityPolynomialLib;
    ...
    function setUp() public {
        string memory identity_poly_wrappers = vm.readFile("test/blocks/mocks/IdentityPolyWrappers.huff");
        identityPolynomialLib = IdentityPolynomialLib(HuffDeployer.deploy_with_code("blocks/IdentityPolynomial", identity_poly_wrappers));
    }
    ...
    function testIdentityPolyEvaluatePrimary() public {
        ...
        uint256 actual = identityPolynomialLib.evaluate(r_prod, VESTA_P_MOD);
    ...
    function testIdentityPolyEvaluateSecondary() public {
        ...
        uint256 actual = identityPolynomialLib.evaluate(r_prod, PALLAS_P_MOD);
